...
Translate to {target_language}.`;
    ...
    function getDefaultConfig(modelName = DEFAULT_GEMINI_MODEL) {
        ...
        return {
            ...
            advancedSettings: {
                ...
                contextSize: 50, // Number of preceding original entries to include as context
    ...
    function areAdvancedSettingsModified() {
        ...
        const ctxSizeChanged = ctxSizeEl ? (parseInt(ctxSizeEl.value) !== (defaults.contextSize || 50)) : false;
