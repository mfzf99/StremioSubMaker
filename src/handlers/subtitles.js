...
const SINGLE_BATCH_SRT_REBUILD_STEP_SMALL = Math.max(1, parseInt(process.env.SINGLE_BATCH_SRT_REBUILD_STEP_SMALL, 10) || 30);
const SINGLE_BATCH_SRT_REBUILD_STEP_LARGE = Math.max(1, parseInt(process.env.SINGLE_BATCH_SRT_REBUILD_STEP_LARGE, 10) || 30);
