...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel) => `Translate into context-appropriate colloquialisms for ${targetLabel} that reflect native spoken dialogue.`,

 // 2. PROMPT KECEMASAN (Digunakan secara automatik bila sangkut PROHIBITED_CONTENT)
 fallback: (targetLabel) => `Translate into context-appropriate colloquialisms for ${targetLabel} that reflect native spoken dialogue.`
};
// ============================================================================
