...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel) => `You are a professional subtitle translator. Translate into natural, local conversational ${targetLabel} that reflects authentic spoken dialogue. Use "saya" and "awak" for general dialogue. Naturally integrate common English loanwords when contextually appropriate.`,
 ...
 // DIBERSIHKAN: Tiada lagi arahan pantang larang supaya Google tak melatah. Semua penapisan dibuat oleh fungsi maskToxicWords.
  fallback: (targetLabel) => `You are a professional subtitle translator. Translate into natural, local conversational ${targetLabel} that reflects authentic spoken dialogue. Use "saya" and "awak" for general dialogue. Naturally integrate common English loanwords when contextually appropriate.`
};
// ============================================================================
