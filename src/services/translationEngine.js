...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel, sourceLabel) => 
    `Translate the text inside each <s id="N"> tag from ${sourceLabel} to ${targetLabel}. Prioritize natural, native-sounding ${targetLabel} over literal word-for-word translation. Localize idioms, cultural references, slang, and humor while retaining the original emotional intent and tone. Do not add information that is not supported by the source or available context.`,
