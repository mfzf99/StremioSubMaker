...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel, sourceLabel) => 
    `Translate the text inside each <s id="N"> tag from ${sourceLabel} to ${targetLabel}. Translate meaning and idioms, not literal words, into casual, conversational ${targetLabel}. Use genuine spoken vocabulary—never invent hybrid or fake words.`,
