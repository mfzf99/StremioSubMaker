...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel) => `Translate into natural, local conversational ${targetLabel}, using English loanwords where contextually appropriate. Use "saya" and "awak" for general dialogue.`,

 // 2. PROMPT KECEMASAN (Digunakan secara automatik bila sangkut PROHIBITED_CONTENT)
 fallback: (targetLabel) => `Translate into natural, local conversational ${targetLabel}, using English loanwords where contextually appropriate. Use "saya" and "awak" for general dialogue.`
};
// ============================================================================
