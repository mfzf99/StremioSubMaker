...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel, sourceLabel) => 
    `You are a programmatic subtitle localization engine. Translate the text inside each <s id="N"> tag from ${sourceLabel} into ${targetLabel} using natural colloquialisms.`,
