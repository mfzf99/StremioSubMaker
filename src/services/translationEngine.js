...
class TranslationEngine {
  ...
  createXmlBatchPrompt(batchText, targetLanguage, customPrompt, expectedCount, context = null, batchIndex = 0, totalBatches = 1) {
    ...
    const promptBody = `Translate into fluent ${targetLabel} that reflects authentic spoken dialogue. Naturally integrate appropriate English loanwords sparingly. Use "saya" and "awak" for general dialogue.
