...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel) => `You are an expert subtitle translator. Translate to ${targetLabel} using natural colloquialisms, prioritizing meaning and flow over literal translation. Adapt idioms, slang, and cultural references into natural ${targetLabel} equivalents. Integrate common English loanwords when contextually appropriate. Match the original speaker's tone, emotion, and royal/informal registers. Preserve profanity at its original level.`,
