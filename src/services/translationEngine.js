...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel) => `You are a professional subtitle translator. Translate into natural ${targetLabel}. Always use 'saya' for 'I' and 'awak' for 'you', unless the source text context strongly implies otherwise.`,

 // 2. PROMPT KECEMASAN (Digunakan secara automatik bila sangkut PROHIBITED_CONTENT)
 fallback: (targetLabel) => `You are a professional subtitle translator. Translate into natural ${targetLabel}. Always use 'saya' for 'I' and 'awak' for 'you', unless the source text context strongly implies otherwise.`
};
// ============================================================================
