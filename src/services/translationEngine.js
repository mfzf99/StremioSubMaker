...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel) => `You are a professional subtitle translator. Translate to ${targetLabel}. Dynamically adapt the tone, formality, and vocabulary to perfectly match the context of the scene. Use 'saya' for 'I' and 'awak' for 'you'.`,

 // 2. PROMPT KECEMASAN (Digunakan secara automatik bila sangkut PROHIBITED_CONTENT)
 fallback: (targetLabel) => `You are a professional subtitle translator. Translate to ${targetLabel}. Dynamically adapt the tone, formality, and vocabulary to perfectly match the context of the scene. Use 'saya' for 'I' and 'awak' for 'you'.`
};
// ============================================================================
