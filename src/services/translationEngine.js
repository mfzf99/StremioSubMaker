...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel, sourceLabel) => 
    `Translate the text inside each <s id="N"> tag from ${sourceLabel} to ${targetLabel}. Translate meaning over words into authentic, natural-sounding spoken dialogue, using appropriate ${targetLabel} colloquialisms while preserving emotional nuance and intent.`,
