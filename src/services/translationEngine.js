...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel, sourceLabel) => 
    `Translate the text inside each <s id="N"> tag from ${sourceLabel} to ${targetLabel}. Maintain the tone, emotional nuance, and character dynamics of the original text. Adapt idioms and slang naturally, prioritizing natural-sounding dialogue over a literal word-for-word translation.`,
