...
`;
    ...
    const promptBody = `You are a high-precision subtitle translator. Translate into natural ${targetLabel} with common English loanwords. Use "saya" and "awak" for general dialogue.
${contextInstructions}
CRITICAL RULES:
