...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel, sourceLabel) => 
    `Translate the text inside each <s id="N"> tag from ${sourceLabel} to ${targetLabel}. Adapt idioms, slang, and cultural references into natural ${targetLabel} equivalents. Match each speaker's tone, emotion, and character register. Preserve profanity at its original level. Keep lines concise for subtitle reading speed.`,

  // 2. PROMPT KECEMASAN (PROHIBITED_CONTENT Fallback - Neutral & Safe)
  fallback: (targetLabel, sourceLabel) => 
    `Translate the text inside each <s id="N"> tag from ${sourceLabel} to ${targetLabel}. Adapt idioms, slang, and cultural references into natural ${targetLabel} equivalents. Match each speaker's tone, emotion, and character register. Keep lines concise for subtitle reading speed.`
};
// ============================================================================
