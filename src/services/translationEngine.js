...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel) => `Translate into context-appropriate colloquialisms for ${targetLabel}. Consistently use 'saya' for 'I' and 'awak' for 'you', unless the source text context strongly implies otherwise.`,

 // 2. PROMPT KECEMASAN (Digunakan secara automatik bila sangkut PROHIBITED_CONTENT)
 fallback: (targetLabel) => `Translate into context-appropriate colloquialisms for ${targetLabel}. Consistently use 'saya' for 'I' and 'awak' for 'you', unless the source text context strongly implies otherwise.`
};
// ============================================================================
