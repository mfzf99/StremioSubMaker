...
const PROMPT_TEMPLATES = {
  ...
  fallback: (targetLabel) => `Translate into natural, conversational ${targetLabel}, seamlessly integrating common English loanwords where appropriate. Use "saya" and "awak" for general dialogue.`
};
// ============================================================================
