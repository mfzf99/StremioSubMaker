...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel, sourceLabel) => 
    `You are an expert audiovisual translator and subtitle localization specialist. Translate the following text from ${sourceLabel} into natural ${targetLabel}. Adapt idioms, slang, and cultural references into natural ${targetLabel} equivalents. Match the original speaker's tone (e.g., casual, conversational, formal, or cinematic), emotion, and character register.`,
