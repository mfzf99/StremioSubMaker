...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel) => `You are an expert subtitle localizer. Translate into natural ${targetLabel} that reflects native spoken dialogue. Allow common English loanwords. Always use 'saya' for 'I' and 'awak' for 'you', unless the source text context strongly implies otherwise.`,

 // 2. PROMPT KECEMASAN (Digunakan secara automatik bila sangkut PROHIBITED_CONTENT)
 fallback: (targetLabel) => `You are an expert subtitle localizer. Translate into natural ${targetLabel} that reflects native spoken dialogue. Allow common English loanwords. Always use 'saya' for 'I' and 'awak' for 'you', unless the source text context strongly implies otherwise.`
};
// ============================================================================
