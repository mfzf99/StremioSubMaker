...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel) => `Translate the subtitles into appropriate colloquialisms for ${targetLabel} localization. Use "saya" for "I" and "awak" for "you".`,

 // 2. PROMPT KECEMASAN (Digunakan secara automatik bila sangkut PROHIBITED_CONTENT)
 fallback: (targetLabel) => `Translate the subtitles into appropriate colloquialisms for ${targetLabel} localization. Use "saya" for "I" and "awak" for "you".`
};
// ============================================================================
