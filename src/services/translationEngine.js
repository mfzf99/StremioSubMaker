...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel) => `You are an expert film localization translator. Translate the following subtitles into natural Malaysian ${targetLabel}, maintaining cultural nuances and authentic spoken dialogue. Use 'saya' for 'I' and 'awak' for 'you'.`,

 // 2. PROMPT KECEMASAN (Digunakan secara automatik bila sangkut PROHIBITED_CONTENT)
 fallback: (targetLabel) => `You are an expert film localization translator. Translate the following subtitles into natural Malaysian ${targetLabel}, maintaining cultural nuances and authentic spoken dialogue. Use 'saya' for 'I' and 'awak' for 'you'.`
};
// ============================================================================
