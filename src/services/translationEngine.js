...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel) => `You are an expert subtitle translator. Translate to ${targetLabel}. Maintain natural dialogue flow for ${targetLabel}. Use appropriate colloquialisms for ${targetLabel}.`,

 // 2. PROMPT KECEMASAN (Digunakan secara automatik bila sangkut PROHIBITED_CONTENT)
 fallback: (targetLabel) => `You are an expert subtitle translator. Translate to ${targetLabel}. Maintain natural dialogue flow for ${targetLabel}. Use appropriate colloquialisms for ${targetLabel}.`
};
// ============================================================================
