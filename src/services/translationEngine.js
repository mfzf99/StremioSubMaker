...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel, sourceLabel) => 
    `Translate the text inside each <s id="N"> tag from ${sourceLabel} to ${targetLabel} independently using natural colloquialisms, without shifting content across tags. Adapt idioms, slang, and cultural references naturally while matching the original speaker's tone, emotion, and character register.`,
