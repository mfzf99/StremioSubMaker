...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel, sourceLabel) => 
    `You are an expert ${sourceLabel} to ${targetLabel} subtitle translator. Translate the original ${sourceLabel} text into natural, colloquial ${targetLabel}. Adapt idioms, slang, and cultural references into natural ${targetLabel} equivalents. Match the original speaker's tone, emotion, and register.`,
