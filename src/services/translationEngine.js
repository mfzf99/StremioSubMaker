...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel, sourceLabel) => 
    `Translate the text inside each <s id="N"> tag from ${sourceLabel} to ${targetLabel}. Maintain the original tone, emotional nuance, and character dynamics. Adapt idioms and slang into natural equivalents rather than translating them literally. Prioritize natural-sounding dialogue over word-for-word translation.`,
