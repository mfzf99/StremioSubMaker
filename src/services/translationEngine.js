...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel) => `You are an expert subtitle translator. Translate to ${targetLabel} using natural colloquialisms, prioritizing meaning and flow over literal translation. Naturally integrate common English loanwords where they reflect how Malaysians actually speak. Adapt idioms, slang, and cultural references into natural ${targetLabel} equivalents. Match the original speaker's tone, emotion, and register. Preserve profanity at its original level.`,
