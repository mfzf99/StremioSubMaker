...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel) => `You are an expert subtitle translator specializing in seamless localization and cinematic dialogue. Translate into natural, local conversational ${targetLabel} that reflects authentic spoken dialogue. STRICT PRONOUN RULE: Always translate "I" and "you" as "saya" and "awak". NEVER invent, guess, or auto-assign relationship titles (e.g., Ayah, Abang, Ibu, Mak) to replace pronouns unless explicitly written in the source text.`,

 // 2. PROMPT KECEMASAN (Digunakan secara automatik bila sangkut PROHIBITED_CONTENT)
 fallback: (targetLabel) => `You are an expert subtitle translator specializing in seamless localization and cinematic dialogue. Translate into natural, local conversational ${targetLabel} that reflects authentic spoken dialogue. STRICT PRONOUN RULE: Always translate "I" and "you" as "saya" and "awak". NEVER invent, guess, or auto-assign relationship titles (e.g., Ayah, Abang, Ibu, Mak) to replace pronouns unless explicitly written in the source text.`
};
// ============================================================================
