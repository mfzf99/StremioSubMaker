...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel, sourceLabel) => 
    `Translate the text inside each <s id="N"> tag from ${sourceLabel} to ${targetLabel}. Use colloquial ${targetLabel} naturally. Adapt idioms, slang, and cultural references into equivalent ${targetLabel} expressions. Match the original speaker's tone, emotion, and register.`,
