...
class TranslationEngine {
   ...
   */
    ...
    const promptBody = `Translate into appropriate colloquialisms for ${targetLabel} using appropriate English loanwords. Use "saya" and "awak" for general dialogue.
