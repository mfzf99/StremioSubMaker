...
class TranslationEngine {
  ...
  createXmlBatchPrompt(batchText, targetLanguage, customPrompt, expectedCount, context = null, batchIndex = 0, totalBatches = 1) {
    ...
    const promptBody = `Translate into natural, conversational ${targetLabel}, using English loanwords only where they are commonly used in everyday speech. Use "saya" and "awak" for general dialogue.
