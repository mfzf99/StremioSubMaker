...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel) => `Translate to ${targetLabel}. Use context-appropriate colloquialisms for ${targetLabel} that sounds native. Consistently use 'saya' for 'I' and 'awak' for 'you', unless the source text context strongly implies otherwise.`,

 // 2. PROMPT KECEMASAN (Digunakan secara automatik bila sangkut PROHIBITED_CONTENT)
 fallback: (targetLabel) => `Translate to ${targetLabel}. Use context-appropriate colloquialisms for ${targetLabel} that sounds native. Consistently use 'saya' for 'I' and 'awak' for 'you', unless the source text context strongly implies otherwise.`
};
// ============================================================================
