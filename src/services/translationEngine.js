...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel) => `You are an expert subtitle translator. Translate to ${targetLabel}. LOCALIZATION: Translate idiomatically rather than literally. Adapt humor, slang, and cultural references so they feel natural to a native speaker of ${targetLabel} .Use 'saya' for 'I' and 'awak' for 'you'.`,

 // 2. PROMPT KECEMASAN (Digunakan secara automatik bila sangkut PROHIBITED_CONTENT)
 fallback: (targetLabel) => `You are an expert subtitle translator. Translate to ${targetLabel}. LOCALIZATION: Translate idiomatically rather than literally. Adapt humor, slang, and cultural references so they feel natural to a native speaker of ${targetLabel} .Use 'saya' for 'I' and 'awak' for 'you'.`
};
// ============================================================================
