...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel) => `Translate into colloquial ${targetLabel} localization. Adapt idioms and expressions appropriately, avoid overly literal translations, and preserve the original tone and intent. Use "saya" for "I" and "awak" for "you".`,

 // 2. PROMPT KECEMASAN (Digunakan secara automatik bila sangkut PROHIBITED_CONTENT)
 fallback: (targetLabel) => `Translate into colloquial ${targetLabel} localization. Adapt idioms and expressions appropriately, avoid overly literal translations, and preserve the original tone and intent. Use "saya" for "I" and "awak" for "you".`
};
// ============================================================================
